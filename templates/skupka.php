...
<?php
	...
	<section class="condition" id="types">
		<div class="layout">
				<h2 class="condition__title">Какую технику мы выкупаем1</h2>
                        ...
                        <div class="online__wrap">
                            ...
                            <div class="contacts__form" id="form">
                                <div class="tg-form-header">
                                    ...
                                    <div class="tg-form-description">Заполните форму и мы отправим вам предварительную стоимость в течении 10 минут</div>
                                </div>
                                ...
                                <form class="tg-form">
                                    ...
                                    <textarea name="ftext" required placeholder="Опишите ваш товар максимально подробно *"></textarea><br/>
