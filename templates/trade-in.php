...
<section class="layout trade-in">
    ...
    <h2 class="trade-in__subtitle text-4xl">
        Принесите старую технику в наш магазин по программе <span
            class="link link-primary">«Trade-in»</span> и купите новый девайс по специальным
        условиям
    </h2>
    <h2 class="trade-in__subtitle trade-in__subtitle--mt text-4xl">
        Как работает <span>«Trade-in»</span>?
    </h2>
