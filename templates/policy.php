...
<section class="layout policy">
                ...
                <div>
                    ...
                    <p class="policy__title-sm text-sm">
                    ...
                    <p class="policy__title-sm text-sm">
                        ...
                        9.4. Действующая Политика конфиденциальности размещена на странице по адресу www.100nout.by/politika-konfidenczialnosti/.
                    </p>
                </div>
            </section>
            <?php get_footer();