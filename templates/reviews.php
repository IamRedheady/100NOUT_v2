...
<section class="reviews layout">
    ...
    <div class="reviews__intro-card reviews__intro-card--logo">
        <h3 class="reviews__intro-card-text text-3xl">
            Мы ценим ваше мнение и будем рады отзывам о нашей работе. Благодарны вам за положительную оценку
            и за конструктивную критику, которая поможет улучшить наш сервис.
        </h3>
    </div>
