...
<section class="reviews layout">
    ...
    <div class="reviews__intro-card">
        <div class="reviews__intro-card-pic">
            <img src="<?php nout_image_directory() ?>logo 100NOUT.svg" alt="Логотип">
        </div>
        <h3 class="reviews__intro-card-text text-3xl">
            Мы ценим ваше мнение и будем рады отзывам о нашей работе. Благодарны вам за положительную
            ценку и за конструктивную критику, которая поможет улучшить наш сервис.
        </h3>
    </div>
