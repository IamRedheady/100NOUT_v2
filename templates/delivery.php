                ...
                <ul class="delivery__list">
                    ...
                    <li class="delivery__list-item">
                        <div class="card delivery__card-item">
								...
								<p class="text-base">
									* Срок хранения заказа в магазине —<span class="delivery__text-color">2 рабочих дня</span>. По истечении этого срока заказ будет аннулирован (Возможно изменение сроков хранения заказа по согласованию с менеджером, при условии наличия большого кол-ва одинаковых позиций на складе). Для юр. лиц срок действия счёт-фактуры 2 рабочих дня, срок хранения заказа после оплаты — 30 дней.
								</p>
						...
						<div class="card delivery__card delivery__card-item">
							...
							<p class="text-lg delivery__card-text delivery__text-sm">
								Если непредвиденные обстоятельства мешают вам получить заказ, необходимо как можно раньше связаться с оператором контактного центра по телефону +375444157400 и договориться о переносе времени или места доставки.
							</p>
