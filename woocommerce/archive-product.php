...
$cat_fields = get_field('cat_fields', 'term_' . $cat_id);
$h1_title = $cat_fields['h1_title'];
$seo_text = $cat_fields['set_text'];

$categories_filter = [];
//$manual_filters = get_field('filtry_kategorii', 'term_' . $cat_id);
//
//if ($manual_filters) {
//    foreach ($manual_filters as $filter_item) {
//        $categories_filter[$filter_item['pre-nazvanie']] = $filter_item['pre-ssylka'];
//    }
//}
...
if (is_product_category()) {
    ...
    foreach ($terms as $term) {
        ...
        $categories_filter[$term->name] = $term_link;
    }
}
?>
<section class="catalog layout">
    ...
    ?>
        ...
        <!-- <div class="catalog__banner banner">
            <img class="banner-xl" src="<?php // echo nout_image_directory();
                                        ?>banners/xl1.png" alt="Баннер">
            <img class="banner-l" src="<?php // echo nout_image_directory();
                                        ?>banners/l1.png" alt="Баннер">
            <img class="banner-m" src="<?php // echo nout_image_directory();
                                        ?>banners/m1.png" alt="Баннер">
            <img class="banner-s" src="<?php // echo nout_image_directory();
                                        ?>banners/s1.png" alt="Баннер">
            <img class="banner-xs" src="<?php // echo nout_image_directory();
                                        ?>banners/xs1.png" alt="Баннер">
        </div> -->
        <style>
        ...
        <div class="catalog__pre">
            <?php
            if (count($categories_filter)) : ?>
                <div class="catalog__pre-list-wrap js-swiper-pre-list">
                    <div class="swiper-button-prev"></div>
                    <div class="catalog__pre-list swiper-wrapper">
                        <?php foreach ($categories_filter as $category_name => $category_link) : ?>
                            <div class="catalog__pre-list-item swiper-slide">
                                <a href="<?= $category_link; ?>" class="catalog__pre-list-item-btn btn btn-secondary">
                                    <?= $category_name; ?>
                                </a>
                            </div>
                        <?php endforeach; ?>
        ...
        ?>
                        ...
                        <div class="catalog__mode">
                            ...
                            <label for="content-base" class="catalog__mode-btn btn btn-icon btn-secondary">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5 3C3.89543 3 3 3.89543 3 5V7C3 8.10457 3.89543 9 5 9H7C8.10457 9 9 8.10457 9 7V5C9 3.89543 8.10457 3 7 3H5Z" fill="#A3A3A3" />
                                    <path d="M5 11C3.89543 11 3 11.8954 3 13V15C3 16.1046 3.89543 17 5 17H7C8.10457 17 9 16.1046 9 15V13C9 11.8954 8.10457 11 7 11H5Z" fill="#A3A3A3" />
                                    <path d="M11 5C11 3.89543 11.8954 3 13 3H15C16.1046 3 17 3.89543 17 5V7C17 8.10457 16.1046 9 15 9H13C11.8954 9 11 8.10457 11 7V5Z" fill="#A3A3A3" />
                                    <path d="M11 13C11 11.8954 11.8954 11 13 11H15C16.1046 11 17 11.8954 17 13V15C17 16.1046 16.1046 17 15 17H13C11.8954 17 11 16.1046 11 15V13Z" fill="#A3A3A3" />
                                </svg>
                            </label>
                            <label for="content-column" class="catalog__mode-btn btn btn-icon btn-secondary">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M3 4C3 3.44772 3.44772 3 4 3H16C16.5523 3 17 3.44772 17 4C17 4.55228 16.5523 5 16 5H4C3.44772 5 3 4.55228 3 4ZM3 8C3 7.44772 3.44772 7 4 7H16C16.5523 7 17 7.44772 17 8C17 8.55228 16.5523 9 16 9H4C3.44772 9 3 8.55228 3 8ZM3 12C3 11.4477 3.44772 11 4 11H16C16.5523 11 17 11.4477 17 12C17 12.5523 16.5523 13 16 13H4C3.44772 13 3 12.5523 3 12ZM3 16C3 15.4477 3.44772 15 4 15H16C16.5523 15 17 15.4477 17 16C17 16.5523 16.5523 17 16 17H4C3.44772 17 3 16.5523 3 16Z" fill="#A3A3A3" />
                                </svg>
                            </label>
                        </div>
                    </div>
            ...
            $is_expandable = $description ? mb_strlen($description) > 300 : false;
            ?>
            <div id="catalog__content-desc" class="catalog__content-desc text-base <?php if ($is_expandable) {
                                                                                        echo 'expandable-content expandable-content--active';
                                                                                    } ?>">
                <?= $description; ?>
            </div>
            <?php if ($is_expandable) : ?>
                <div class="expandable-content__controls">
                    <button class="expandable-content__toggle" data-content-selector="#catalog__content-desc" data-collapse-text="Скрыть" data-expand-text="Читать полностью">
                        Читать полностью
                    </button>
                </div>
            <?php endif; ?>
