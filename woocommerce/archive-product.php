    ...
    ?>
        ...
        <?php
            if ( wc_get_loop_prop( 'total' ) ) {
                ...
                ?>
                <div id="catalog__content-desc"
                     class="catalog__content-desc text-base <?php if($is_expandable) {echo 'expandable-content expandable-content--active';} ?>">
                    <?= $description; ?>
                </div>
                <?php if($is_expandable): ?>
                    <div class="expandable-content__controls">
                        <button class="expandable-content__toggle"
                                data-content-selector="#catalog__content-desc"
                                data-collapse-text="Скрыть"
                                data-expand-text="Читать полностью">
                            Читать полностью
                        </button>
                    </div>
                <?php endif; ?>
