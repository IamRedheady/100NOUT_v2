...
function nout_scripts() {
	wp_enqueue_style( 'awad-style', get_template_directory_uri() . '/dist/css/app.css', array(), time() );

	wp_enqueue_script( 'awad-js', get_template_directory_uri() . '/dist/js/app.js', array(), time(), true );
